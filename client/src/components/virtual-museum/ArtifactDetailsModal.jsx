      ...
      <DialogContent className="max-w-[95vw] w-full h-[95vh] max-h-[95vh] p-0 bg-white sm:max-w-6xl sm:h-[90vh] sm:max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 bg-white shrink-0">
          <div className="flex-1 min-w-0 pr-4">
            <h1 className="text-lg sm:text-2xl font-medium text-gray-800 truncate">
              {artifact.title}
            </h1>
        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          <div className="flex flex-col lg:flex-row h-full">
            {/* Image Section */}
            <div className="relative bg-gray-100 flex items-center justify-center h-64 sm:h-80 lg:h-full lg:w-1/2 shrink-0">
                  ...
                  <Tabs defaultValue="overview" className="w-full">
                        ...
                        <div className="space-y-3">
                          ...
                          {truncatedDescription.needsTruncation && (
                            <Button
                              variant="ghost"
                              size="sm"
                              className="text-yellow-700 hover:text-yellow-800 hover:bg-yellow-50 p-0 h-auto font-medium text-sm"
                              onClick={() =>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {artifact.tags.map((tag) => (
                            <Badge
                              key={tag}
                              variant="outline"
                              className="bg-gray-50 text-gray-700 border-gray-200 hover:bg-gray-100 text-xs"
                            >
                              {tag}
                            </Badge>
                          ))}
                    ...
                    <TabsContent value="context" className="space-y-6 mt-0">
                      ...
                      <div>
                        ...
                        <Card>
                          <CardContent className="p-3 sm:p-4 bg-yellow-50 border-yellow-200">
