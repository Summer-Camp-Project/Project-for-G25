  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        variant === "destructive"
          ? "text-red-600 focus:bg-red-100 focus:text-red-600"
          : "",
...
function DropdownMenuCheckboxItem({ className, children, checked, ...props }) {
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "focus:bg-blue-100 focus:text-blue-900 relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none",
...
function DropdownMenuSubTrigger({ className, inset, children, ...props }) {
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-blue-100 focus:text-blue-900 data-[state=open]:bg-blue-100 data-[state=open]:text-blue-900 flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8",
        className,
      )}
      {...props}
    >
